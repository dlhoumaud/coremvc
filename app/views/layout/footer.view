<footer class="bg-dark text-white">
            ...
            <section class="">
                ...
                <div class="row mt-3">
                    ...
                    <p>
                        <a href="#!" class="text-reset">CSS3</a>
                    </p>
                    <p>
                        <a href="#!" class="text-reset">Javascript</a>
                    </p>
                    <p>
                        <a href="#!" class="text-reset">PHP/SQL</a>
                    </p>
                    </div>
                    <!-- Grid column -->
                    ...
                    <p><i class="fas fa-phone me-3"></i> +33 6xx xxx xxx</p>
                    </div>
                    <!-- Grid column -->
                </div>
                <!-- Grid row -->
            ...
            <div class="text-center p-4" style="background-color: rgba(0, 0, 0, 0.05);">
                © <?= date('Y') ?> Copyright : 
                <a class="text-reset fw-bold" href="https://github.com/dlhoumaud/coremvc">coremvc.github</a>
            </div>
            <!-- Copyright -->
        </footer>